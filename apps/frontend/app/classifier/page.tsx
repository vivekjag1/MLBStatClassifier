...
const Page = () => {
    ...
    return (
        <div className = " grid grid-cols-2  ml-20 overflow-hidden bg-gray-200">
            <div className="items-center justify-center text-center h-screen  bg-gray-200 rounded-tr-xl rounded-br-xl ">
